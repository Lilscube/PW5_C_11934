    ...
    <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5" >
        <div class="row gx-lg-5 align-items-center mb-5">
            <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10;">
                ...
                <p class="mb-4 opacity-70" style="color: hsl(207,91%,85%); text-align: justify;">
                    Dengan fasilitas modern dan intruktur profesional, Anda bisa berlatih dengan cara yang lebih efisien dan aman. Apakah tujuan Anda adalah menambah masa otot,
